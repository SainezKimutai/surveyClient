...
import { AdminThirdPartyGuard } from 'src/app/shared/route-guards/admin-thirdparty.guard';
// Plugins
...
const routes: Routes = [
    ...
    { path: '', component: HomeComponent,
      children: [
        ...
        { path: 'dashboard', loadChildren: 'src/app/components/home/dashboard/dashboard.module#DashboardModule', canActivate: [AdminThirdPartyGuard], data: {preload: true}},
        ...
        { path: 'editorial', loadChildren: 'src/app/components/home/editorial/editorial.module#EditorialModule', canActivate: [AdminThirdPartyGuard], data: {preload: true}},
